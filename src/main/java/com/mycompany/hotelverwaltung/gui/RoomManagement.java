...
public class RoomManagement extends javax.swing.JFrame {
     ...
     */
    public RoomManagement(PersistenceInterface pi) {
        this.pi = pi;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Zimmerverwaltung - B&V Hotels");
        setResizable(false);
        ...
        jLabel1.setText("ZIMMERVERWALTUNG");
        ...
        newRoomButton.setBackground(new java.awt.Color(255, 255, 255));
        newRoomButton.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        newRoomButton.setForeground(new java.awt.Color(22, 76, 136));
        newRoomButton.setText("Neues Zimmer");
        newRoomButton.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dispose();
        RoomList s = new RoomList(pi, pi.getRoomList());
        s.setVisible(true);
